...
import { fetchGeminiRealTimeToken } from "../actions/action";
import { GEMINI_CHANNEL_NAME } from "@/inngest/channel/gemini";

interface BaseGeminiNodeProps extends NodeProps {
  name?: string;
  description?: string;
  status?: NodeStatus;
  children?: ReactNode;
